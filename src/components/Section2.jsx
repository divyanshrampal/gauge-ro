...
const Section2 = () => {
  ...
  <div className="lg:pl-16 px-4 mx-auto flex  pt-20 lg:pt-10  lg:flex-row flex-col-reverse   mb-3 lg:mb-6">
    <div className="lg:flex-grow lg:w-1/2  flex flex-col md:items-start md:text-left mb-16 md:mb-0  text-start lg:mx-auto">
      <div>
        <div className="font-bold pl-12 pr-6 py-3 lg:max-w-fit w-fit mt-10 bg-white rounded-full shadow-lg relative">
      ...
      <div className="lg:pr-12 ">
        ...
        <div className="flex  relative">
          <div className="check-icon  mt-9 mr-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width={18}
              height={18}
          ...
          <div className="info-wrap">
            <h2 className="text-xl  lg:w-full  mb-3 font-bold font-plusJakartaSans capitalize text-gray-800 mt-8">
      ...
      <button className="rounded-full bg-blue-500 w-fit lg:px-12 px-10 lg:py-5 py-5 flex m-auto mt-6 lg:mt-2 md:mb-14">
        <a
    ...
    <div className="lg:w-1/2 w-full lg:pt-10  ">
      <img
        ...
        alt="image"
        className="object-cover relative object-center rounded transition-transform duration-300 ease-in-out hover:-translate-y-2 max-w-full cursor-pointer w-full sm:pr-4"
      />
    </div>
  </div>
</section>
